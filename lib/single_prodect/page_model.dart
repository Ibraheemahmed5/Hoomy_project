      ...
      children: [
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              Text("د.ع"+'${BackEnd.Prodects3[prodects].price.toString()}',style: GoogleFonts.inter(fontSize: 21,color: Colors.black,fontWeight: FontWeight.bold)),
              Text(BackEnd.Prodects3[prodects].title,style: GoogleFonts.inter(fontSize: 21,color: Colors.black,fontWeight: FontWeight.bold)),
            ],
          ),
        ),
        Padding(
              ...
              child: Padding(
                ...
                child:ListView(
                  ...
                  textDirection: TextDirection.rtl,
                   child: Text(BackEnd.Prodects3[prodects].description,style: TextStyle(fontSize: 16,color: Color(0xff2D7FA5)),)
                  )],
                ) ,
              )
          ),
