...
import 'package:hoomy_project1/single_prodect/Catigories_single_prodect/page_model2.dart';
import 'package:hoomy_project1/single_prodect/Catigories_single_prodect/test2.dart';
...
class SingleProdectCat extends StatefulWidget {
  const SingleProdectCat({Key? key, required this.prodects}) : super(key: key);
  final int prodects;

  @override
  State<SingleProdectCat> createState() => _SingleProdectCatState(prodects);
}

class _SingleProdectCatState extends State<SingleProdectCat> {
  final int prodects;
  _SingleProdectCatState(this.prodects);
      ...
      bottomNavigationBar: Container(
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              if( BackEnd.categoryList[prodects].isAvailable== false)
                Text(
                    ' غير متوفر',
              ...
              if( BackEnd.categoryList[prodects].isAvailable== true)
                Text(
                    textDirection: TextDirection.rtl,

                    "${BackEnd.categoryList[prodects].price.toString()}  د.ع",
                    // ' ${RelatedList(
                    //   prodect: prodects,
