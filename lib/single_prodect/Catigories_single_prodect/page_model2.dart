...
class PageModel2 extends StatelessWidget {
  const PageModel2({Key? key, required this.prodects}) : super(key: key);
  final int prodects;
          ...
          child: Container(
            child: Row(
              ...
              children: [
                ...
                Text("${BackEnd.categoryList[prodects].title.substring(0,((BackEnd.categoryList[prodects].title.toString().length)>15? 15: BackEnd.categoryList[prodects].title.toString().length) )}",
                    style: Text_Style.getstyle(
                        fontsize: 25,
                        ColorText: Colors.black,
                        fontWeight: FontWeight.bold)),
          ...
          child: Padding(
            ...
            child: ListView(
              children: [
                Directionality(
                  textDirection: TextDirection.rtl,
                  child: Text(BackEnd.categoryList[prodects].description,
                      style: Text_Style.getstyle(
                          fontsize: 16,
