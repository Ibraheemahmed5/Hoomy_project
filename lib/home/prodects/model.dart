...
class Prodect {
  ...
  static RxList<String> ImagesList = <String>[
    'photo/hoomy1.png',
    'photo/hoomy2.png',
    'photo/22.png',
    'photo/22.png',
  ...
  static addItem(String name, int price, String image_link, String desc,
      String catigory, List<int> pcolor, int quantity) {
    Prodect data =
        Prodect(name, price, ImagesList, pcolor, catigory, desc, quantity);
    Prodects.add(data);
  }
}
